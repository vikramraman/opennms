...
public class SyslogdLoadIT implements InitializingBean {
    ...
    public void testSyslogConnectionHandlerDefaultImpl() throws Exception {
        ...
        SyslogConnection[] connections = new SyslogConnection[eventCount];
        ...
        for (int i = 0; i < eventCount; i++) {
            ...
            connections[i] = new SyslogConnection(pkt, m_config, m_distPollerDao.whoami().getId(), m_distPollerDao.whoami().getLocation());
        }
